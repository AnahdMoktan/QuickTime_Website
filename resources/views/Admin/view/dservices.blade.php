        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-dark">Dsevices</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="#">Home</a></li>
                                <li class="breadcrumb-item active">Dservices</li>
                            </ol>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                    @if (session('success'))
                    ...
                    <div class="input-group mb-3" style="margin-top: 30px;">
                      <form method="POST" action="{{ url('dservices') }}"
                        ...
                        <tbody>
                            @foreach($dservices as $i=>$ds)
                                <tr>
                                    ...
                                    <td>
                                        <a href="#editdservices{{ $ds->id }}" data-toggle="modal">
                                            <i class="fas fa-edit">Edit</i>
                                        </a>
                                        &nbsp;
                                        <a
                                            href="{{ url('dservices/delete',array($ds->id)) }}">
                                    ...
                                    <td style="float:left">
                                        ...
                                        <div class="modal" tabindex="-1" id="editdservices{{ $ds->id }}">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form method="POST"
                                                            action="{{ url('dservices/update',array($ds->id)) }}"
