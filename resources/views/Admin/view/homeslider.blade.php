        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    ...
                    @if (session('success'))
                        ...
                        @endif
                         @if (session('delete'))                  
                            ...
                            @endif
                    @php
                        $homeslider = App\Homeslider::get();
                    @endphp
                    <form method="POST" action="{{ url('homeslider') }}"
                    ...
                    <h3 style="text-align:center">Home Slider Contents</h3>
                    <table class="table">
                        <thead>
                            <tr>
                                <th scope="col">Id</th>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <img height="80" width="80"
                                            src="{{ url(implode('storage',explode('public',$hs['image']))) }}">
                                    </td>
                                    <td>
                                    <a href="#editslider{{$hs->id}}" data-toggle="modal">
                                            <i class="fas fa-edit">Edit</i>
                                        </a>
                                        &nbsp;
                                        <a
                                            href="{{ url('homeslider/delete',array($hs->id)) }}">
                                    ...
                                    <div class="modal" tabindex="-1" id="editslider{{$hs->id}}">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <form method="POST"  action="{{ url('homeslider/update',array($hs->id)) }}" enctype="multipart/form-data" id="uploadForm">
                                                            {{ csrf_field() }}
                                                            <div class="form-group">
                                                              <label for="">Title</label>
                                                            <input class="form-control" name="title" value="{{$hs['title']}}"/>
                                                          </div>
                                                          <div class="form-group">
                                                              <label for="">Image</label>
